    ...
    <div className="cyber-panel p-5 sm:p-6 rounded-3xl border-2 border-cyan-500/40 bg-slate-950/85 cyber-hud-brackets shadow-2xl relative overflow-hidden font-orbitron">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
          <div className="relative group">
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-gradient-to-tr from-cyan-400 via-purple-600 to-pink-500 p-1 shadow-xl shadow-cyan-500/20 group-hover:scale-105 transition duration-300">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-xl sm:text-2xl font-black text-white tracking-wider">{userData?.profile?.name || 'Hero Candidate'}</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mt-5 pt-4 border-t border-slate-800 text-xs font-orbitron font-bold">
        ...
        >
          ...
          <span className="text-white font-mono">{safeNum(userData?.profile?.stats?.int, 45)}</span>
        </div>
        ...
        >
          ...
          <span className="text-white font-mono">{safeNum(userData?.profile?.stats?.wis, 30)}</span>
        </div>
        ...
        >
          ...
          <span className="text-white font-mono">{safeNum(userData?.profile?.stats?.dex, 25)}</span>
        </div>
        ...
        >
          ...
          <span className="text-white font-mono">{safeNum(userData?.profile?.stats?.vit, 20)}</span>
        </div>
      </div>
